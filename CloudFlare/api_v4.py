...
def api_v4(self):
    ...
    setattr(self, "user",
            self._client_with_auth(self.base, "user"))
    user = getattr(self, "user")
    setattr(user, "billing",
            self._unused(self.base, "user/billing"))
    ...
    setattr(user_billing_subscriptions, "apps",
            self._client_with_auth(self.base, "user/billing/subscriptions/apps"))
    setattr(user_billing_subscriptions, "zones",
            self._client_with_auth(self.base, "user/billing/subscriptions/zones"))
    setattr(user, "firewall",
            self._unused(self.base, "user/firewall"))
    ...
    setattr(user_firewall_access_rules, "rules",
            self._client_with_auth(self.base, "user/firewall/access_rules/rules"))
    setattr(user, "organizations",
            self._client_with_auth(self.base, "user/organizations"))
    setattr(user, "invites",
            self._client_with_auth(self.base, "user/invites"))
    ...
    setattr(zones_custom_certificates, "prioritize",
            self._client_with_auth(self.base, "zones", "custom_certificates/prioritize"))
    ...
    setattr(zones_settings, "advanced_ddos",
            self._client_with_auth(self.base, "zones", "settings/advanced_ddos"))
    setattr(zones_settings, "always_online",
            self._client_with_auth(self.base, "zones", "settings/always_online"))
    setattr(zones_settings, "browser_cache_ttl",
            self._client_with_auth(self.base, "zones", "settings/browser_cache_ttl"))
    setattr(zones_settings, "browser_check",
            self._client_with_auth(self.base, "zones", "settings/browser_check"))
    setattr(zones_settings, "cache_level",
            self._client_with_auth(self.base, "zones", "settings/cache_level"))
    setattr(zones_settings, "challenge_ttl",
            self._client_with_auth(self.base, "zones", "settings/challenge_ttl"))
    setattr(zones_settings, "development_mode",
            self._client_with_auth(self.base, "zones", "settings/development_mode"))
    setattr(zones_settings, "email_obfuscation",
            self._client_with_auth(self.base, "zones", "settings/email_obfuscation"))
    setattr(zones_settings, "hotlink_protection",
            self._client_with_auth(self.base, "zones", "settings/hotlink_protection"))
    setattr(zones_settings, "ip_geolocation",
            self._client_with_auth(self.base, "zones", "settings/ip_geolocation"))
    ...
    setattr(zones_settings, "mobile_redirect",
            self._client_with_auth(self.base, "zones", "settings/mobile_redirect"))
    setattr(zones_settings, "origin_error_page_pass_thru",
            self._client_with_auth(self.base, "zones", "settings/origin_error_page_pass_thru"))
    ...
    setattr(zones_settings, "prefetch_preload",
            self._client_with_auth(self.base, "zones", "settings/prefetch_preload"))
    setattr(zones_settings, "response_buffering",
            self._client_with_auth(self.base, "zones", "settings/response_buffering"))
    setattr(zones_settings, "rocket_loader",
            self._client_with_auth(self.base, "zones", "settings/rocket_loader"))
    setattr(zones_settings, "security_header",
            self._client_with_auth(self.base, "zones", "settings/security_header"))
    setattr(zones_settings, "security_level",
            self._client_with_auth(self.base, "zones", "settings/security_level"))
    setattr(zones_settings, "server_side_exclude",
            self._client_with_auth(self.base, "zones", "settings/server_side_exclude"))
    setattr(zones_settings, "sort_query_string_for_cache",
            self._client_with_auth(self.base, "zones", "settings/sort_query_string_for_cache"))
    setattr(zones_settings, "ssl",
            self._client_with_auth(self.base, "zones", "settings/ssl"))
    setattr(zones_settings, "tls_1_2_only",
            self._client_with_auth(self.base, "zones", "settings/tls_1_2_only"))
    setattr(zones_settings, "tls_client_auth",
            self._client_with_auth(self.base, "zones", "settings/tls_client_auth"))
    setattr(zones_settings, "true_client_ip_header",
            self._client_with_auth(self.base, "zones", "settings/true_client_ip_header"))
    ...
    setattr(zones, "firewall",
            self._unused(self.base, "zones", "firewall"))
    ...
    setattr(zones_firewall_waf, "packages",
            self._client_with_auth(self.base, "zones", "firewall/waf/packages"))
    zones_firewall_waf_packages = getattr(zones_firewall_waf, "packages")
    setattr(zones_firewall_waf_packages, "groups",
            self._client_with_auth(self.base, "zones", "firewall/waf/packages", "groups"))
    setattr(zones_firewall_waf_packages, "rules",
            self._client_with_auth(self.base, "zones", "firewall/waf/packages", "rules"))
    zones_firewall_access_rules = getattr(zones_firewall, "access_rules")
    setattr(zones_firewall_access_rules, "rules",
            self._client_with_auth(self.base, "zones", "firewall/access_rules/rules"))

    # The API commands for /railguns/
    setattr(self, "railguns",
            self._client_with_auth(self.base, "railguns"))
    ...
    setattr(organizations_railguns, "zones",
            self._client_with_auth(self.base, "organizations", "railguns", "zones"))
    ...
    setattr(organizations_firewall_access_rules, "rules",
            self._client_with_auth(self.base, "organizations", "firewall/access_rules/rules"))
    ...
    setattr(self, "ips",
            self._client_noauth(self.base, "ips"))
    ...
    setattr(zones, "ssl",
            self._unused(self.base, "zones", "ssl"))
    zones_ssl = getattr(zones, "ssl")
    setattr(zones_ssl, "certificate_packs",
            self._client_with_auth(self.base, "zones", "ssl/certificate_packs"))
